...
> **Werdykt WiFi (zależny od chipu):** AX200/AX201 (Go 2/3, Pro 7/8) działają przez `iwlwifi`, ale tylko **802.11 a/b/g**; QCA6174 (oryginalny Go, wiele Pro 4–6) ma `ath10k` odłączony → **brak WiFi, użyj donglea USB**.
